...
namespace Countwords
{
    class Program
    {
        ...
        {
            string adr, pathcont, pathres,resdownload;
           ...
           if (adr.Length < 10 || adr.Substring(0,7)!="http://" || !adr.Contains("."))
           {
            ...
            resdownload=zagruz.Web(adr, pathcont);
            if (resdownload == "")
            {
    ...
    class Download
    {
        ...
        public string Web(string adr, string path)
        {
            try
            {
    ...
    class Sorting
    {
        ...
        public void Count(string pathc, string pathr)
        {
            ...
            {
                Console.WriteLine("\nНе найден файл \"contains.txt\" с содержимым сайта!\n");
                logger.Error("Не найден файл contains.txt");
            }
        }
    }
    ...
    class Baza
    {
        ...
        public void Import(string name, string path)
        {
            ...
            try
            {
                ...
                string queryDel = "DROP TABLE " + a ;

                SqlCommand sqlDelTab = new SqlCommand(queryDel, myConn);

                sqlDelTab.ExecuteNonQuery();
                ...
                SqlCommand sqlNewTab = new SqlCommand(query, myConn);
                    ...
                    Console.WriteLine($"\nВ базе данных создана таблица c именем \"{a}\"");
